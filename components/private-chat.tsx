...
export function PrivateChat({ roomId, userId, username }: { roomId: string; userId: string; username: string }) {
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 메시지 목록 업데이트
      const updatedResponse = await fetch(`/api/chat/rooms/${roomId}/messages`)
